...
ReferenceImages = ["stopTemplate.png", "speedLimitTemplate.png", "Stop!",
                   "Ny Fartsgrense!"]
...
# define class instances (2 objects for 2 different images)
                ...
                if area > minSquareArea:
                    ...
                    for i in range(6):
                        ...
                        if diff < minDiff:
                            ...
                            cv2.putText(OriginalFrame, symbol[i].name, tuple(approx.reshape(4, 2)[0]), font, 1,
