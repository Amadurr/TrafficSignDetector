...
ReferenceImages = ["ArrowL.png","ArrowR.png","ArrowT.png","Ball.png","Go.png","Stop.png","Turn Around","Search for Ball","Start..","Stop!"]
...
def main():
    ...
    SignImage = cv2.imread('Stop.png', 1)
